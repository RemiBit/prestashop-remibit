...
class RemiBitPaymentModuleFrontController extends ModuleFrontController
{
    /**
     * Request RemiBit and get Response
     */
    ...
    public function postProcess()
    {
        ...
        /**
         * Create post params for RemiBit
         */
        $timeStamp          = time();
        ...
        $relay_url = $this->context->link->getModuleLink('remibit', 'validation', array(), true);;
