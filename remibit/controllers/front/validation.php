...
class RemiBitValidationModuleFrontController extends ModuleFrontController
{
    /**
     * Validate Payment
     *
    ...
    /**
     * Check for valid remibit server callback to validate the transaction response.
     **/
