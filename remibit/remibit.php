<?php
/**
 * RemiBit - A Sample Payment Module for PrestaShop 1.7
 *
...
class RemiBit extends PaymentModule
{
    private $_html = '';
    ...
    public function __construct()
    {
        ...
        $this->version                = '1.0';
        $this->author                 = 'RemiBit Team';
        $this->controllers            = array('payment', 'validation');
        $this->currencies             = true;
        $this->currencies_mode        = 'checkbox';
        $this->bootstrap              = true;
        $this->displayName            = 'RemiBit';
        $this->description            = 'RemiBit Payment Module';
...
//        $formAction = $this->context->link->getModuleLink($this->name, 'validation', array(), true);
         ...
         */
        $paymentForm = $this->fetch('module:remibit/views/templates/hooks/payment_option.tpl');
    ...
    public function hookPaymentReturn($params)
    {
        ...
        return $this->fetch('module:remibit/views/templates/hooks/payment_return.tpl');
    }
}
